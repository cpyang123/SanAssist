...
if __name__ == "__main__":
    input_file_path = "/dbfs/data/augmented_patient_data.csv"  # Adjust the path as needed
    delta_table_path = "/mnt/delta/patient_data"  # Adjust the Delta table path as needed
